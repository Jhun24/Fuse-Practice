...
/* #00000000; /usr/local/Teamcity/Agents/tcagent-osx-agent01-teamcity-dyson/work/b939dc4c6ac331f9/Source/Outracks.Simulator.Compiler/Selection/RuntimeSelection.cs ; */


#pragma reset

/* #00000000; /usr/local/Teamcity/Agents/tcagent-osx-agent01-teamcity-dyson/work/b939dc4c6ac331f9/Source/Outracks.Simulator.Compiler/CodeGeneration/RuntimeTagRegistry.cs ; */
...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.0.15"), 12124)}, "/Users/janghunlee/Desktop/example/example.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("example");
}
}
}
